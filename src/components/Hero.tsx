                ...
                <div className="relative z-20 text-center px-5 max-w-4xl mx-auto flex flex-col items-center mt-10">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 justify-center mt-2 w-full sm:w-auto">
                        ...
                        <a
                            ...
                            className="inline-flex items-stretch rounded-md overflow-hidden border border-white font-semibold text-sm transition-colors duration-150"
                        >
                            {/* Green icon panel */}
                            <span className="bg-[#25D366] hover:bg-[#1ebe5d] flex items-center justify-center px-3.5 transition-colors duration-150">
                            ...
                            {/* Text panel */}
                            <span className="bg-white text-[#2c2420] hover:bg-gray-100 px-5 py-3.5 flex items-center transition-colors duration-150">
                                Chat on WhatsApp
                            </span>
                        </a>
                    </div>
